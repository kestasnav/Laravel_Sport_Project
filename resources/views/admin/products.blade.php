        ...
        <div class="col-md-12 mt-5 mb-5">
            <div class="card">
                <div class="card-header"> {{ __('Produktai') }}
                    <a class="text-decoration-none text-black float-end mt-2" href="{{ route('products.create') }}"><i
                                ...
                                @foreach($products as $product)
                                    ...
                                    <td class="text-center">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li class="nav-item">
                                                <a class="dropdown-item border-bottom" href="{{ route('products.edit', $product->id) }}"><i class="fa-solid fa-pencil"></i> {{ __('Atnaujinti') }}</a>
                                            </li>
